...
class ChecklistData {
  static final List<Map<String, dynamic>> checklistItems = [
    ...
    {'task': '1. Tay Halkası - Hasar veya aşınma kontrolü', 'completed': false},
    {'task': '2. Taç Halkası - Hasar ve korozyon kontrolü', 'completed': true},
    {'task': '3. Dikey Yük Şeritleri - Taç halkasındaki geri dönüşler', 'completed': true},
    {'task': '4. Dikey Yük Şeritleri - Diğer şeritler ile kesişme noktası', 'completed': true},
    {'task': '5. Dikey Yük Şeritleri - Hasar ve yanık kontrolü', 'completed': true},
    {'task': '6. Dikey Yük Şeritleri - Bağlantı noktalarında kılıflar ve geri dönüşler', 'completed': true},
    ...
    {'task': '10. Kumaş Paneller - Hasar veya delik kontrolü', 'completed': true},
    ...
    {'task': '13. Kumaş Paneller - Birleşme yerleri ve dikişler', 'completed': true},
    ...
    {'task': '19. Tüp Sensörü - Kurulu ve iyi durumda', 'completed': true},
    {'task': '20. Gizli Termometre - Aşırı ısınma kontrolü', 'completed': true},
    {'task': '21. Çelik Halatlar - Hasar ve korozyon kontrolü', 'completed': true},
    {'task': '22. Karabina - Korozyon ve çalışırlık kontrolü', 'completed': true},
    {'task': '23. Bakımlar - Üretici manuellere göre yapıldı', 'completed': true},
    {'task': '24. Velko - Uygunluk ve durum kontrolü', 'completed': true},
    ...
    {'task': 'BURNER (Pasha Balloons)', 'completed': true, 'isHeader': true},
    {'task': '1. Burner Genel Durumu - Hasar kontrolü', 'completed': true},
    {'task': '2. Valfler - Düzgün çalışma ve kapanma kontrolü', 'completed': true},
    {'task': '3. Yakıt Sistemi - Sızıntı kontrolü', 'completed': true},
    {'task': '4. Jeler - Çalışma ve tıkanıklık kontrolü', 'completed': true},
    ...
    {'task': 'GENEL ŞARTLAR', 'completed': true, 'isHeader': true},
    ...
    {'task': '4. Hava şartlarının uygun olması', 'completed': true},
